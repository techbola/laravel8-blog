        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" placeholder="Enter your full name" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('name') border-red-500 @enderror" value="{{ old('name') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" id="email" placeholder="Enter your email address" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('email') border-red-500 @enderror" value="{{ old('email') }}">
                ...
                <div class="mb-4">
                    <button type="submit" class="bg-blue-500 text-white w-full px-4 py-3 font-medium rounded">
                        Register
                    </button>
                </div>
            </form>
